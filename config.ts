...
export const FACEBOOK_LOGIN_ENABLED: boolean = true;
export const GOOGLE_LOGIN_ENABLED: boolean = false; // Google login is disabled because it's not working well for some users.
export const EMAIL_LOGIN_ENABLED: boolean = true;
